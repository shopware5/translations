...
return [
    ['name' => 'Base', 'label' => 'Shopinstellingen', 'description' => null],
    ['name' => 'Core', 'label' => 'Systeem', 'description' => null],
    ['name' => 'Product', 'label' => 'Artikelen', 'description' => null],
    ['name' => 'Frontend', 'label' => 'Frontend', 'description' => null],
    ['name' => 'Interface', 'label' => 'Interfaces', 'description' => null],
    ['name' => 'Payment', 'label' => 'Betaalmethoden', 'description' => null],
    ['name' => 'Product29', 'label' => 'Artikelnummers', 'description' => null],
    ['name' => 'Product35', 'label' => 'Overige BTW-tarieven', 'description' => null],
    ['name' => 'PriceGroup', 'label' => 'Prijsgroepen', 'description' => null],
    ['name' => 'Unit', 'label' => 'Prijseenheden', 'description' => null],
    ['name' => 'Attribute', 'label' => 'Artikelen - vrije velden', 'description' => null],
    ['name' => 'Rating', 'label' => 'Klantbeoordelingen', 'description' => null],
    ['name' => 'Other', 'label' => 'Overige instellingen', 'description' => null],
    ['name' => 'LastArticles', 'label' => 'Laatst bekeken artikelen', 'description' => null],
    ['name' => 'Shop', 'label' => 'Shops', 'description' => null],
    ['name' => 'MasterData', 'label' => 'Basisgegevens', 'description' => null],
    ['name' => 'Currency', 'label' => 'Valuta\'s', 'description' => null],
    ['name' => 'Locale', 'label' => 'Localisaties', 'description' => null],
    ['name' => 'Template', 'label' => 'Templates', 'description' => null],
    ['name' => 'Tax', 'label' => 'Belastingen', 'description' => null],
    ['name' => 'Mail', 'label' => 'Mailers', 'description' => null],
    ['name' => 'Number', 'label' => 'Nummerreeksen', 'description' => null],
    ['name' => 'CustomerGroup', 'label' => 'Klantgroepen', 'description' => null],
    ['name' => 'Service', 'label' => 'Onderhoud', 'description' => null],
    ['name' => 'AdvancedMenu', 'label' => 'Uitgebreid menu', 'description' => null],
    ['name' => 'Compare', 'label' => 'Artikelvergelijking', 'description' => null],
    ['name' => 'TagCloud', 'label' => 'Tag cloud', 'description' => null],
    ['name' => 'Frontend30', 'label' => 'Categorieën / lijsten', 'description' => null],
    ['name' => 'Frontend76', 'label' => 'Topseller / noviteiten', 'description' => null],
    ['name' => 'Frontend77', 'label' => 'Cross selling / artikelgegevens', 'description' => null],
    ['name' => 'Frontend79', 'label' => 'Winkelmand / artikelgegevens', 'description' => null],
    ['name' => 'Frontend33', 'label' => 'Aanmelden / registreren', 'description' => null],
    ['name' => 'Statistics', 'label' => 'Statistieken', 'description' => null],
    ['name' => 'Google', 'label' => 'Google Analytics', 'description' => null],
    ['name' => 'Log', 'label' => 'Log', 'description' => null],
    ['name' => 'Country', 'label' => 'Landen', 'description' => null],
    ['name' => 'InputFilter', 'label' => 'Inputfilter', 'description' => null],
    ['name' => 'Search', 'label' => 'Zoekfunctie', 'description' => null],
    ['name' => 'Frontend71', 'label' => 'Kortingen / toeslagen', 'description' => null],
    ['name' => 'Frontend60', 'label' => 'E-mailinstellingen', 'description' => null],
    ['name' => 'Frontend93', 'label' => 'Verzendkostenmodule', 'description' => null],
    ['name' => 'Frontend101', 'label' => 'Controle BTW ID-nummer', 'description' => null],
    ['name' => 'Frontend100', 'label' => 'SEO / routerinstellingen', 'description' => null],
    ['name' => 'Widget', 'label' => 'Widgets', 'description' => null],
    ['name' => 'CountryArea', 'label' => 'Landregio\'s', 'description' => null],
    ['name' => 'Esd', 'label' => 'ESD', 'description' => null],
    ['name' => 'Recommendation', 'label' => 'Artikelaanbevelingen', 'description' => null],
    ['name' => 'Checkout', 'label' => 'Bestelling afronden', 'description' => null],
    ['name' => 'PageGroup', 'label' => 'Winkelpagina-groepen', 'description' => null],
    ['name' => 'CronJob', 'label' => 'Cronjobs', 'description' => null],
    ['name' => 'Auth', 'label' => 'Backend', 'description' => null],
    ['name' => 'Document', 'label' => 'PDF document creation', 'description' => null],
    ['name' => 'StoreApi', 'label' => 'Store API', 'description' => null],
    ['name' => 'LegacyOptions', 'label' => 'Legacy-opties', 'description' => null],
    ['name' => 'Passwörter', 'label' => 'Wachtwoorden', 'description' => null],
    [
        'name' => 'TrustedShop',
        'label' => 'Trusted shops',
        'description' => '
...
<div class="info">
	<h2>Keurmerk en kopersbescherming </h2>
	<p>
        Trusted Shops certificeert webwinkels door deze aan een groot aantal zorgvuldig gekozen criteria te toetsen voordat het Europese keurmerk wordt toegekend. In combinatie met de geld-terug-garantie van Trusted Shops en de klantbeoordelingen kunt u met zekerheid online winkelen.
	</p>


	<h2> Meer vertrouwen, hogere omzet!</h2>
	<p>
		De vertrouwde winke
        ls Seal of Approval is optimaal voor het opbouwen van het vertrouwen van uw online klanten. Vertrouwen verhoogt de bereidheid van uw klanten om bij u kopen.	</p>

	<h2> Minder verlaten winkelwagentjes </h2>
	<p>
        U uw online klanten bieden een sterk argument: de vertrouwde winkels kopersbescherming. Met deze extra beveiliging, zullen minder aankopen worden geannuleerd.
	</p>

	<h2> Rendabele en duurzame klantrelaties </h2>
	<p>
		De vertrouwde winkels Seal of Approval met kopersbescherming is een duurzame kwaliteit functie voor veilig winkelen op het Web voor vele online shoppers. First-time kopers worden vaste klanten.
	</p>
	<div class="register">
		<a class="button" href="https://www.trustedshops.nl/retailers/" target="_blank">
			Meer informatie en aanmelden!
		</a>
	</div>
</div>'
    ],
    ['name' => 'SEPA', 'label' => 'SEPA-configuratie', 'description' => null],
    [
        'name' => 'Newsletter',
        'label' => 'Nieuwsbrief',
        'description' => null,
    ...
    [
        'name' => 'HttpCache',
        'label' => 'Frontend cache (HTTP cache)',
        'description' => null,
    ],
    [
        'name' => 'SwagUpdate',
