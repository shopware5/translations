...
class Shopware_Plugins_Core_SwagFrance_Bootstrap extends Shopware_Components_Plugin_Bootstrap
{
    /**
     * @var array
     */
    ...
    public function uninstall()
    {
        ...
        $id = $localeRepository->findOneBy(['locale' => 'fr_FR'])->getId();
    ...
    public function onPostDispatchBackendIndex(Enlight_Event_EventArgs $args)
    {
        ...
        $view->extendsTemplate('backend/index/swag_france/header.tpl');
    }
