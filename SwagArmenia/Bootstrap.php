 ...
 */
class Shopware_Plugins_Core_SwagArmenia_Bootstrap extends Shopware_Components_Plugin_Bootstrap
{
    /**
     * {@inheritdoc}
     */
    ...
    public function install()
    {
        ...
        /** @var \Shopware\Models\Shop\Locale $armenianLocale */
        $armenianLocale = $localeRepository->findOneBy(['locale' => 'hy_AM']);
        if ($armenianLocale === null) {
            return parent::uninstall();
        }

        $armenianLocaleId = $armenianLocale->getId();
    ...
    public function uninstall()
    {
        ...
        if (($index = array_search($armenianLocaleId, $locales)) !== false) {
            unset($locales[$index]);
            $element->setValue($locales);
            $modelManager->flush($element);
        }
